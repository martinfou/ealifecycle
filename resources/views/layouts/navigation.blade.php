                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="relative" x-data="{ adminOpen: false }">
                        <button @click="adminOpen = !adminOpen" 
                                class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-300 hover:text-white hover:border-blue-400 focus:outline-none focus:text-white focus:border-blue-400 transition duration-150 ease-in-out {{ request()->routeIs('admin.*') ? 'border-blue-400 text-white' : 'border-transparent' }}">
                            {{ __('Admin') }}
                        ...
                        <div x-show="adminOpen" 
                             ...
                             x-transition
                             class="absolute left-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-md shadow-lg py-1 z-50">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1 bg-gray-900">
            ...
            <div class="pt-2 pb-2 border-t border-gray-700">
                <div class="px-4 text-xs font-semibold text-gray-400 uppercase tracking-widest">
                    Admin
                </div>
