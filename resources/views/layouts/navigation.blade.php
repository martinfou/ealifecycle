                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="relative" x-data="{ adminOpen: false }">
                        <button @click="adminOpen = !adminOpen" 
                                class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out {{ request()->routeIs('admin.*') ? 'border-indigo-400 text-gray-900' : 'border-transparent' }}">
                            {{ __('Admin') }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-2 pb-2 border-t border-gray-200">
                <div class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-widest">
                    Admin
                </div>
